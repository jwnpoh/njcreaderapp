...
func (uDB *UsersDB) UpdateUser(newUser *core.User) error {
	query := "UPDATE users SET hash = $1, last_login = $2, display_name = $3 WHERE id = $4"
...
func (uDB *UsersDB) UpdateClasses(users *[]core.User) error {
	query := "UPDATE users SET class = $1 WHERE display_name = $2"
...
func (uDB *UsersDB) DeleteUser(id uuid.UUID) error {
