...
<form method="POST" action="?/add">
  ...
  <div class="flex pt-4 md:pt-6 justify-center items-center ">
    <div
      class="card w-11/12 md:w-10/12 shadow-md shadow-yellow-300 bg-yellow-200 bg-opacity-40"
    >
      <div class="card-body px-6 md:px-12">
        ...
        <div class="pt-4">
          ...
          <textarea
            ...
            class="textarea px-2 py-2 w-screen max-w-full bg-secondary bg-opacity-10"
            bind:value={tldr}
        ...
        <div class="pt-4">
          ...
          <textarea
            ...
            class="textarea my-2 px-2 py-2 w-screen max-w-full bg-secondary bg-opacity-10"
            bind:value={notes}
